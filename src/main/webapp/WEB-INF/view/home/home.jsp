				...
				<div class="product-item bg-light mb-4">
					<div class="product-img position-relative overflow-hidden">
						...
						<div class="product-action">
							<a class="btn btn-outline-dark btn-square" href="addWish.do?pno=${product.productNo }"><i class="far fa-heart"></i></a> <a class="btn btn-outline-dark btn-square" href="productInfo.do?pno=${product.productNo}"><i class="fa fa-search"></i></a>
						</div>
					</div>
